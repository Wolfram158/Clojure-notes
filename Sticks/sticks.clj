                    ...
                    (do
                      ...
                      (if
                        ...
                        (do
                          ...
                          (if
                            (and
                              (= (get (get @(:configuration board) 0) (dec @x2)) "_")
                              (= (get (get @(:configuration board) 2) (dec @x2)) "_")
                              (= (get (get @(:configuration board) 1) @x2) "|")
                              (= (get (get @(:configuration board) 1) (- @x2 2)) "|"))
                            (do
                      ...
                      (if
                        ...
                        (do
                          ...
                          (if
                            (and
                              (= (get (get @(:configuration board) (- @y2 2)) (dec @x2)) "_")
                              (= (get (get @(:configuration board) @y2) (dec @x2)) "_")
                              (= (get (get @(:configuration board) (dec @y2)) @x2) "|")
                              (= (get (get @(:configuration board) (dec @y2)) (- @x2 2)) "|"))
                            (do
                              (swap! current-bonus inc)
                              (swap! (:score (get players @whose-turn)) inc)
                              (swap! (:configuration board) #(assoc %
                      ...
                      (if
                        ...
                        (do
                          ...
                          (if
                            (and
                              (= (get (get @(:configuration board) (- @y2 2)) (inc @x2)) "_")
                              (= (get (get @(:configuration board) @y2) (inc @x2)) "_")
                              (= (get (get @(:configuration board) (dec @y2)) @x2) "|")
                              (= (get (get @(:configuration board) (dec @y2)) (+ @x2 2)) "|"))
                            (do
                              (swap! current-bonus inc)
                        ...
                        (do
                          ...
                          (if
                            (and
                              (= (get (get @(:configuration board) @y2) (dec @x2)) "_")
                              (= (get (get @(:configuration board) (+ @y2 2)) (dec @x2)) "_")
                              (= (get (get @(:configuration board) (inc @y2)) @x2) "|")
                              (= (get (get @(:configuration board) (inc @y2)) (- @x2 2)) "|"))
                            (do
                              (swap! current-bonus inc)
                              (swap! (:score (get players @whose-turn)) inc)
                              (swap! (:configuration board) #(assoc %
